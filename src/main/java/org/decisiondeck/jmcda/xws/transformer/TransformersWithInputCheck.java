...
public class TransformersWithInputCheck {
	...
	final Class<? extends FunctionWithInputCheck<?, ?>> fctClass = (Class<? extends FunctionWithInputCheck<?, ?>>) function
		.getClass();
     ...
     */
    static public Method getApplyMethod(Class<? extends FunctionWithInputCheck<?, ?>> function) {
